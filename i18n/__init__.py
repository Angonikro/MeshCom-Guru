...
_language = "de"
_SUPPORTED_LANGUAGES = ("de", "en", "it", "nl", "fr", "es", "sv", "pl")
_catalogs = {}
_base = os.path.dirname(__file__)
for _lang in ("de", "en", "it", "nl", "fr", "es", "sv", "pl"):
    try:
...
for _lang in ("it", "nl", "fr", "es", "sv", "pl"):
    try:
        with open(os.path.join(_base, _lang + ".json"), "r", encoding="utf-8") as _f:
...
_UI = {
    "Datensicherung erstellen …": "Create backup …",
    "Datensicherung wiederherstellen …": "Restore backup …",
    "Datensicherung erstellen": "Create backup",
    "Datensicherung wiederherstellen": "Restore backup",
    "Datensicherung": "Backup",
    "Datensicherung erfolgreich erstellt: ": "Backup created successfully: ",
    "Datensicherung fehlgeschlagen: ": "Backup failed: ",
    "Wiederherstellung fehlgeschlagen: ": "Restore failed: ",
    "Nach Update suchen …": "Check for updates …",
    "Nach Update suchen": "Check for updates",
    "Update verfügbar": "Update available",
    "Eine neue MeshCom-Guru-Version ist verfügbar.": "A new MeshCom-Guru version is available.",
    "Installiert": "Installed",
    "Neu": "New",
    "GitHub Release öffnen": "Open GitHub release",
    "Du verwendest bereits die aktuelle Version.": "You are already using the latest version.",
    "Die GitHub-Release-Prüfung konnte nicht durchgeführt werden: ": "The GitHub release check could not be completed: ",
    "Die persönlichen Einstellungen aus dem Backup werden in ~/.MeshCom wiederhergestellt. Nicht zum Backup gehörende Dateien werden nicht gelöscht. Nach der Wiederherstellung ist ein Neustart von MeshCom-Guru erforderlich. Fortfahren?": "The personal settings from the backup will be restored to ~/.MeshCom. Files not contained in the backup will not be deleted. MeshCom-Guru must be restarted after the restore. Continue?",
    "Datensicherung erfolgreich wiederhergestellt. MeshCom-Guru jetzt beenden, damit die Einstellungen beim nächsten Start übernommen werden?": "Backup restored successfully. Quit MeshCom-Guru now so the settings are applied on the next start?",
    "Datei": "File",
